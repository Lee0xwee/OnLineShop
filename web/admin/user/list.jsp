            ...
            <td colspan="7">
                ...
                共${pageBean.totalCount}条记录&nbsp;&nbsp;&nbsp;</span>
                    <s:if test="pageBean.pageNumber!=1">
                        <a href="${pageContext.request.contextPath }/userAdmin_findAll.action?pageNumber=1"
                           class="firstPage">&nbsp;</a>
                        <a href="${pageContext.request.contextPath }/userAdmin_findAll.action?pageNumber=${pageBean.pageNumber-1}"
                    ...
                    <c:forEach begin="${begin}" end="${end}" var="i">
                        <c:choose>
                            <c:when test="${i != pageBean.pageNumber}">
                                <a href="${pageContext.request.contextPath }/userAdmin_findAll.action?&pageNumber=${i} ">
                                        ${i }
                                </a>
                            </c:when>
                    ...
                    <s:if test="pageBean.pageNumber!=pageBean.totalPage">
                        <a class="nextPage"
                           href="${pageContext.request.contextPath }/userAdmin_findAll.action?pageNumber=${pageBean.pageNumber+1}">&nbsp;</a>

                        <a class="lastPage"
                           href="${pageContext.request.contextPath }/userAdmin_findAll.action?pageNumber=${pageBean.totalPage}">&nbsp;</a>
                    </s:if>
                    <s:else>
