            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="85%" align="left">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <font color="#000000" style="font-size: 24px;font-family: 隶书">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td width="155" valign="bottom"
                                    background="${pageContext.request.contextPath}/images/mis_05b.jpg">
                                    <font style="font-size: 22px;font-family: 隶书">用户名：</font>
                                    <font color="blue" style="font-size: 22px;font-family: 隶书">
                                        <s:property value="#session.adminUser.username"/></font>
                                </td>
