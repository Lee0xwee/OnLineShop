...
<div class="container cart">
    ...
    <div class="span24">
        ...
        <div class="step step1" style="margin: 10px 20px 5px 10px;color: red">
            <h1>订单信息</h1>
        </div>
        ...
        <div class="total">
            <em id="promotion"></em>
            商品金额: <strong id="effectivePrice">￥${model.total}元</strong>
        </div>
        <form id="orderForm" action="${pageContext.request.contextPath}/order_payOrder.action" method="post">
            ...
            <div class="span24">
                <p>
                    收货地址：<input name="addr" type="text" value="${model.user.addr}" style="width:350px"/>
                    <br/>
                    收货人&nbsp;&nbsp;&nbsp;：<input name="name" type="text" value="${model.user.name}"
                                                 style="width:150px"/>
                    <br/>
                    联系方式：<input name="phone" type="text" value="${model.user.phone}" style="width:150px"/>
