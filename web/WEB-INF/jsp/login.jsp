    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#captchaImage").click(function () {
                ...
                $("#captchaImage").get(0).src = "${pageContext.request.contextPath}/checkImg.action?time=" + new Date().getTime();
                ...
                <div class="main">
                    <div class="title">
                     ...
                     <div style="text-align: center">
                         <strong style="color: red;font-size: 20px"><s:actionmessage/></strong>
                     </div>
