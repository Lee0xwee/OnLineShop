    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#username").blur(function () {
                ...
                $.post("${pageContext.request.contextPath}/user_checkUser.action",
            ...
            $("#captchaImage").click(function () {
                ...
                // 第二种设置方式
                var src_v = "${pageContext.request.contextPath}/checkImg.action?time=" + new Date().getTime();
                $("#captchaImage").attr("src", src_v);
            })
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${ pageContext.request.contextPath }/user_regist.action"
                      method="post"
